...
core::Property LinuxPowerManagerService::BatteryMonitorMode("Battery Monitor Mode", "Supports All ( all must be above threshold ), AtLeastOne ( at least one must be above threshold)");
...
bool LinuxPowerManagerService::isAboveMax(int current_tasks) {
  return false;
}
