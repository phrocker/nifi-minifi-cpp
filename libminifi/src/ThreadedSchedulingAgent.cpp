...
void ThreadedSchedulingAgent::schedule(std::shared_ptr<core::Processor> processor) {
  ...
  auto processContext = core::ClassLoader::getDefaultClassLoader().instantiateType< core::ProcessContext >("ProcessContext", processor_node, controller_service_provider_, repo_, flow_repo_, configure_, content_repo_);
