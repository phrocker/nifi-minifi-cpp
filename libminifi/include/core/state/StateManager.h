 ...
 */
class StateManager : public metrics::MetricsSource, public metrics::MetricsSink, public StateMonitor, public std::enable_shared_from_this<StateManager>
{
 public:
   ...
   * Metrics operations
   */
  virtual int16_t getMetrics(std::vector<std::shared_ptr<metrics::Metrics>> &metric_vector);
