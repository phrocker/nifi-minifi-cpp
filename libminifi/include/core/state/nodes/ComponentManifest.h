 ...
 */
#ifndef LIBMINIFI_INCLUDE_CORE_STATE_NODES_COMPONENTMANIFEST_H_
#define LIBMINIFI_INCLUDE_CORE_STATE_NODES_COMPONENTMANIFEST_H_
...
#endif /* LIBMINIFI_INCLUDE_CORE_STATE_NODES_COMPONENTMANIFEST_H_ */
