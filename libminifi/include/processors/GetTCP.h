...
class SocketAfterExecute : public utils::AfterExecute<int> {
 public:
  explicit SocketAfterExecute(std::atomic<bool> &running)
...
class DataHandler {
 public:
  DataHandler(core::ProcessSessionFactory *sessionFactory)
 ...
 private:
  core::ProcessSessionFactory *sessionFactory_;
...
// Processor Name
 ...
 private:
  ...
  uint16_t connectionAttemptLimit;
