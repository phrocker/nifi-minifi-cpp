 ...
 */
class UpdatePolicyControllerService : public core::controller::ControllerService, public minifi::io::NetworkPrioritizer, public std::enable_shared_from_this<UpdatePolicyControllerService> {
 public:
