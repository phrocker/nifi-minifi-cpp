...
public:
	 ...
	 * @param value value to write
	 */
	virtual int readLongLong(uint64_t &value, bool is_little_endian =
	 ...
	 * @param value value to write
	 */
	virtual int readLong(uint32_t &value, bool is_little_endian =
			EndiannessCheck::IS_LITTLE);
	 ...
	 * @param value value to write
	 */
	virtual int readShort(uint16_t &value, bool is_little_endian =
			EndiannessCheck::IS_LITTLE);
