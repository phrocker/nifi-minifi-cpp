...
TEST_CASE("Test Relationships", "[rel1]") {
  ...
  REQUIRE("failure" ==  relationships.children[0].name);
  REQUIRE("description" ==  relationships.children[0].children[0].name);
  REQUIRE("success" ==  relationships.children[1].name);
  REQUIRE("description" ==  relationships.children[1].children[0].name);
}
