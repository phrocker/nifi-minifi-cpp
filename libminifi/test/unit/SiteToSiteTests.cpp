...
TEST_CASE("TestSiteToSiteVerifyNegotiationSendFlows", "[S2S2]") {
  ...
  protocol.writeRequestType(minifi::SEND_FLOWFILES);
}

TEST_CASE("TestSiteToSiteVerifyNegotiation2", "[S2S2]") {
  ...
  REQUIRE(false == bootstrap_succeed);
}

TEST_CASE("TestSiteToSiteVerifyNegotiationHangUp", "[S2S2]") {
