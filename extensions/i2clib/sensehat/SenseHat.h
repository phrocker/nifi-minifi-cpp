 ...
 */
#ifndef __SENSE_HAT_H__
#define __SENSE_HAT_H__
...
// SenseHAT Class
class SenseHAT : public core::Processor {
 public:
   ...
   */
  SenseHAT(std::string name, uuid_t uuid = NULL)
      : Processor(name, uuid),
        imu(nullptr),
        humidity_sensor_(nullptr),
        pressure_sensor_(nullptr),
        logger_(logging::LoggerFactory<SenseHAT>::getLogger()) {
  }
  // Destructor
  virtual ~SenseHAT();
  // Processor Name
