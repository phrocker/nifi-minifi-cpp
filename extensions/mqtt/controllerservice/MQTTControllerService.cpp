...
core::Property MQTTControllerService::Password(core::PropertyBuilder::createProperty("Password")->withDescription("Password to use when connecting to the broker")->sensitive(true)->build());
