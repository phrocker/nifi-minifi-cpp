...
SET(PROCESSOR_INPUT_DOCS "${CMAKE_SOURCE_DIR}/docs/processors")
SET(PROCESSOR_DOC "${CMAKE_SOURCE_DIR}/PROCESSORS.md")
...
ADD_CUSTOM_TARGET(gen-processor-docs 
		COMMAND minifiexe docs ${PROCESSOR_INPUT_DOCS} ${PROCESSOR_DOC}
		WORKING_DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR}
		VERBATIM
		)